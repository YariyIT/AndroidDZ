...
public class PictureCards extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (prefProgressPictureCards){
            case 1:
                attempts = 4;
                errorCounter = 3;
                break;
        ...
        imgPictureCardsTable = findViewById(R.id.img_picture_cards_table);
            ...
            public void onClick(View v) {
                ...
                if (errorCounter < 0) {
                    ...
                    if (attempts < 10) {
                        ...
                        editor.putInt("proPicCar", prefProgressPictureCards + 1);       // Сохраняем по ключу -Level-, значение -2-
